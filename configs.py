...
class Config(object):
    ...
    BOT_SESSION_NAME = os.getenv("MovieSearchBot")
    USER_SESSION_STRING = os.getenv("1BVtsOLoBu6eq18GX7t_ihHkq8Qqn2P9bt2MnAzphhtnMM0i-0AKwiPOt2JT7klmtyhSaHuXbMkWqXikKLqaM5uAKQVbezZRSBog-0pXeF4zzM07iN7EYF20EoQvVK-WYw9wGwNZDtfQFVglAfzvopxJ6ui60Wi_etA8pPM4cFEO2d-8zs5fnfW-T7N6tItejNbpfhHdvn7G9lCsawznXhVsj3a5whhBIP_Clu2mUsZkNmShV0JfQfqc4eSL3seg_pUmCmBqZlwSylwWIRW6DXmUDpGidfM3Ge6mUXlIYTOX0GuPnSx1B46lENhD1OTWZ3M8vXIc0h5IuzqHzoERU6ubF6Qc37qY=", "String")
    CHANNEL_ID = int(os.getenv("-1001804612762")) 
    BOT_USERNAME = os.getenv("database_movie_search_bot")
    BOT_OWNER = int(os.getenv("1959160420"))
#    OWNER_USERNAME = os.getenv("Official_Mr_Prince06")
    BACKUP_CHANNEL = os.getenv("backup_zone_available")
