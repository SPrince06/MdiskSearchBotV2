...
class Config(object):
    API_ID = int(os.getenv("API_ID", "26113756"))
    API_HASH = os.getenv("API_HASH", "c4ab190d245888c76cdb3c8a60f8ee9e")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5949621954:AAHD7J_t5pmzOICSaiIXqi5wGqFIOwJaZsc")
    BOT_SESSION_NAME = os.getenv(" BOT_SESSION_NAME", "MovieSearchBot")
    USER_SESSION_STRING = os.getenv(" USER_SESSION_STRING", "1BVtsOLoBu6eq18GX7t_ihHkq8Qqn2P9bt2MnAzphhtnMM0i-0AKwiPOt2JT7klmtyhSaHuXbMkWqXikKLqaM5uAKQVbezZRSBog-0pXeF4zzM07iN7EYF20EoQvVK-WYw9wGwNZDtfQFVglAfzvopxJ6ui60Wi_etA8pPM4cFEO2d-8zs5fnfW-T7N6tItejNbpfhHdvn7G9lCsawznXhVsj3a5whhBIP_Clu2mUsZkNmShV0JfQfqc4eSL3seg_pUmCmBqZlwSylwWIRW6DXmUDpGidfM3Ge6mUXlIYTOX0GuPnSx1B46lENhD1OTWZ3M8vXIc0h5IuzqHzoERU6ubF6Qc37qY=", "String")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001804612762")) 
    BOT_USERNAME = os.getenv(" BOT_USERNAME", "database_movie_search_bot")
    BOT_OWNER = int(os.getenv(" BOT_OWNER", "1959160420"))
#    OWNER_USERNAME = os.getenv(" OWNER_USERNANE", "Official_Mr_Prince06")
    BACKUP_CHANNEL = os.getenv(" BACKUP_CHANNEL", "backup_zone_available")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001787803091")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://postbot:postbot@cluster0.ouwne8q.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001155708832"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "backup_zone_available")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @Official_Mr_Prince06 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
